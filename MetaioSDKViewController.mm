...
#define SDK_LICENSE "sXbQt629ppdmBaqGdmQbbb0LA2Dr8KpXBeKQ50EInQw=" 
...
- (void) viewDidLoad
{
    ...
    /*
     //本来はここでライセンスを取得するのだけど、metaio提供のExampleでは動いて、
     //ここで作った方は動いていない。仕方ないので、defineしたSDK_LICENSEをぶち込んだら、
     //動いた。かなしい。
